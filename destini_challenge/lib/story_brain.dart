...
class StoryBrain {
  ...
  String getStory(int storynumber) {
    return _storyData[storynumber].storyTitle ?? "Story text unavailable";
  }

  String getChoice1(int storynumber) {
    return _storyData[storynumber].choice1 ?? "Choice 1 text unavailable";
  }

  String getChoice2(int storynumber) {
    return _storyData[storynumber].choice2 ?? "Choice 2 text unavailable";
  }
}
